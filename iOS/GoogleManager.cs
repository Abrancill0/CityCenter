...
namespace City_Center.iOS
{
	...
	{
        private Action<City_Center.Models.GoogleUser, string> _onLoginComplete;
        ...
        public void Login(Action<City_Center.Models.GoogleUser, string> OnLoginComplete)
		{
		...
		public void DidSignIn(SignIn signIn, Google.SignIn.GoogleUser user, NSError error)
		{
			...
			if (user != null && error == null)
                _onLoginComplete?.Invoke(new City_Center.Models.GoogleUser()
				{
